              ...
              <table class="table">
                  <thead>
                    <tr>
                      ...
                      <th scope="col">AC Barth</th>
                      <th scope="col">AC S</th>
                      <th scope="col">Snigdha</th>
                      <th scope="col">S_chair</th>
                    </tr><br>
                  </thead>
                  <tbody>';
                  ...
                  while($row = mysqli_fetch_assoc($result_seats)){
                    ...
                    echo '<td>'.$row["AC_Barth"].'</td>';
                    echo '<td>'.$row["AC_S"].'</td>';
                    echo '<td>'.$row["Snigdha"].'</td>';
                    echo '<td>'.$row["S_chair"].'</td>';
                    echo '</tr>';}
                 echo '</tbody>
                </table>
          </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-8 col-md-2">
                <div class="display"> 
                    ...
                    <div class="form_container_display">
                        <form action="modifyseatphp.php" method="post">
                            <fieldset>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" id="acb" name="acb" class="form-control" placeholder="">
                                </div>

                                <div class="mb-3">
                                    <label for="acs" class="form-label">Number of AC S_Chair Seats</label>
                                    <input type="number" id="acs" name="acs" class="form-control" placeholder="">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="submit" name="update_submit" class="btn btn-primary" id="update_submit" value="Update">
                            </fieldset>
                        </form>
                    </div>
                </div>
