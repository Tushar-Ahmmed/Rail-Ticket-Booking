                ...
                <div class="take_center">
                    <form action="search.php" method="post">
                        <fieldset>
                            ...
                            <div class="mb-3">
                                <label for="off_day" class="form-label">Date</label>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="submit" name="search_submit" class="btn btn-primary" id="" value="Search">
                        </fieldset>
                    </form>
                </div>
            </div>
